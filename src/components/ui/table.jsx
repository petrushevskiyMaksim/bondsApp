...
const Table = React.forwardRef(({ className, ...props }, ref) => (
	<div className='p-6 relative w-full overflow-auto'>
		<table
			ref={ref}
...
const TableHead = React.forwardRef(({ className, ...props }, ref) => (
	<th
		ref={ref}
		className={cn(
			'h-12 px-4 text-left align-middle font-bolt ssm:text-lg text-neutral-900 [&:has([role=checkbox])]:pr-0 dark:text-neutral-400',
			className
		)}
		{...props}
	/>
